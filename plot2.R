# plot2.R 
#
# This file defines and runs a function plot2() and support functions
...
#
# plot2() is the top-level function that does all the script's processing
#
plot2 <- function() {
    ...
    # Plot  Global Active Power and label as ref. plot
    plot (working_data$Global_active_power ~ working_data$Date_time,
          type="l",
          xlab="",
